...
const CSV_IMPORT_COLUMNS = [
  {
    ...
    header: '업적 코드 (필수)',
    required: true,
    description: '시스템 식별자. 영문 대문자/언더스코어 권장. 예: FIRST_REVIEW, WATCH_100',
  ...
  },
  {
    ...
    header: '업적명 (필수)',
    required: true,
    description: '사용자에게 노출되는 업적 표시명. 예: 첫 리뷰 작성',
    example: '첫 리뷰 작성',
    example2: '100편 감상 달성',
  },
  {
  ...
  {
    key: 'category',
    header: '카테고리 (선택, VIEWING/SOCIAL/COLLECTION/CHALLENGE)',
